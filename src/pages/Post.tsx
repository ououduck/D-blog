      ...
      <motion.article initial={{ opacity: 0, y: 50 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0 }} transition={{ duration: 0.6, ease: 'easeOut' }}>
        ...
        <div ref={articleBodyRef} className="mx-auto flex max-w-3xl flex-col gap-8 px-4 pb-20 md:px-0 md:pb-32">
          <div className="flex-1">
            <div className="prose prose-base max-w-none prose-stone dark:prose-invert md:prose-lg prose-headings:scroll-mt-24 prose-headings:font-serif prose-headings:font-bold prose-headings:text-ink dark:prose-headings:text-white prose-h1:mb-8 prose-h1:mt-12 prose-h1:text-4xl md:prose-h1:mb-10 md:prose-h1:mt-16 md:prose-h1:text-5xl prose-h2:mb-6 prose-h2:mt-12 prose-h2:text-3xl md:prose-h2:mb-8 md:prose-h2:mt-16 md:prose-h2:text-4xl prose-h3:mb-5 prose-h3:mt-10 prose-h3:text-2xl md:prose-h3:mb-6 md:prose-h3:mt-12 md:prose-h3:text-3xl prose-h4:mb-4 prose-h4:mt-8 md:prose-h4:mb-5 md:prose-h4:mt-10 prose-p:mb-7 prose-p:font-sans prose-p:text-[17px] prose-p:leading-[1.9] prose-p:tracking-[0.01em] md:prose-p:mb-9 md:prose-p:text-[19px] md:prose-p:leading-[1.95] prose-a:break-words prose-a:text-zinc-900 prose-a:font-semibold prose-a:underline prose-a:decoration-zinc-300 prose-a:decoration-2 prose-a:underline-offset-[3px] prose-a:transition-all hover:prose-a:decoration-zinc-900 hover:prose-a:underline-offset-[5px] dark:prose-a:text-zinc-100 dark:prose-a:decoration-zinc-700 dark:hover:prose-a:decoration-zinc-400 prose-strong:font-bold prose-strong:text-ink dark:prose-strong:text-white prose-img:my-10 prose-img:h-auto prose-img:w-full prose-img:max-w-full prose-img:cursor-zoom-in prose-img:rounded-xl prose-img:shadow-lg prose-img:transition-transform hover:prose-img:scale-[1.01] dark:prose-img:rounded-2xl md:prose-img:my-16 md:prose-img:rounded-2xl prose-blockquote:my-10 prose-blockquote:rounded-r-xl prose-blockquote:border-l-4 prose-blockquote:border-l-zinc-900 prose-blockquote:bg-zinc-50 prose-blockquote:px-7 prose-blockquote:py-6 prose-blockquote:font-serif prose-blockquote:not-italic prose-blockquote:text-[17px] prose-blockquote:leading-[1.85] dark:prose-blockquote:border-l-zinc-100 dark:prose-blockquote:bg-zinc-900 md:prose-blockquote:my-12 md:prose-blockquote:rounded-r-2xl md:prose-blockquote:px-10 md:prose-blockquote:py-8 md:prose-blockquote:text-[19px] prose-code:font-mono prose-code:text-[13px] prose-code:font-medium md:prose-code:text-[14px] prose-pre:overflow-hidden prose-pre:rounded-xl prose-pre:border prose-pre:border-zinc-800 prose-pre:bg-[#0d1117] prose-pre:p-0 prose-pre:shadow-xl md:prose-pre:rounded-2xl prose-ul:my-7 prose-ul:space-y-3 md:prose-ul:my-9 md:prose-ul:space-y-4 prose-ol:my-7 prose-ol:space-y-3 md:prose-ol:my-9 md:prose-ol:space-y-4 prose-li:text-[17px] prose-li:leading-[1.85] prose-li:marker:text-zinc-500 dark:prose-li:marker:text-zinc-500 md:prose-li:text-[19px] md:prose-li:leading-[1.9] prose-hr:my-12 prose-hr:border-zinc-200 dark:prose-hr:border-zinc-800 md:prose-hr:my-16 prose-table:my-10 md:prose-table:my-12">
              <ReactMarkdown
