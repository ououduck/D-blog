  ...
  return (
    <>
      ...
      <article>
        ...
        <div ref={articleBodyRef} className="mx-auto flex max-w-4xl flex-col gap-8 px-4 pb-16 sm:max-w-5xl md:max-w-6xl lg:max-w-7xl md:px-6 lg:px-8 pb-16 md:pb-24">
          <div className="flex-1 rounded-2xl bg-white px-6 py-8 shadow-sm dark:bg-zinc-900 sm:px-8 md:px-10 md:py-12 lg:px-12">
