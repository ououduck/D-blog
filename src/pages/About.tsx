  ...
  return (
    <div className="mx-auto max-w-4xl pb-10 pt-6 md:pb-16 md:pt-10">
      ...
      <header className="mb-6 md:mb-8">
        ...
        <h1 className="text-4xl font-bold tracking-tight text-zinc-900 dark:text-zinc-100 md:text-5xl">关于我</h1>
      </header>
      ...
      <Surface className="overflow-hidden">
        <div className="grid md:grid-cols-[13rem_minmax(0,1fr)]">
          ...
          <div className="p-6 sm:p-8">
            ...
            <h2 className="mb-2 text-3xl font-bold text-zinc-900 dark:text-zinc-100 md:text-4xl">
              {siteConfig.author.name}
            </h2>
            <p className="mb-6 text-xs font-semibold uppercase tracking-wider text-zinc-500 dark:text-zinc-400">
        ...
        <Surface className="flex min-h-64 flex-col p-5 sm:p-6">
          <div className="mb-6 flex items-center gap-3">
            ...
            <div>
              ...
              <h2 className="text-2xl font-bold text-zinc-900 dark:text-zinc-100">技术栈</h2>
            </div>
          </div>
