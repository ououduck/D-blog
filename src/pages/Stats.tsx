...
const SummaryCard = ({
  ...
  return (
    <div className="group relative overflow-hidden rounded-xl bg-white/90 dark:bg-zinc-900/90 border border-zinc-200/80 dark:border-zinc-800/80 p-5 transition-all duration-200 dark:hover:border-zinc-700 sm:rounded-2xl sm:p-6">
...
export const Stats = () => {
  ...
  return (
    <div className="pb-10 md:pb-20">
      ...
      <section className="mt-8 rounded-2xl bg-white/90 dark:bg-zinc-900/90 border border-zinc-200/80 dark:border-zinc-800/80 p-4 sm:rounded-2xl sm:p-5 md:mt-12 md:p-6 lg:mt-14 lg:p-8">
        <div className="mb-5 flex items-center gap-2.5 md:mb-6">
          <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-zinc-100 text-zinc-700 dark:bg-zinc-800 dark:text-zinc-300">
            <BarChart3 size={18} />
          </div>
