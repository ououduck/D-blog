...
const SummaryCard = ({
  ...
  <div className="border-t border-zinc-200 py-5 dark:border-zinc-800 sm:py-6">
    <div className="mb-4 inline-flex h-11 w-11 items-center justify-center rounded-icon bg-zinc-100 text-zinc-700 dark:bg-zinc-800 dark:text-zinc-300 sm:h-12 sm:w-12">
    ...
    <div className="pb-10 md:pb-20">
      ...
      <section className="mt-10 border-t border-zinc-200 pt-8 dark:border-zinc-800 md:mt-12">
        <div className="mb-5 flex items-center gap-2.5 md:mb-6">
          <div className="flex h-9 w-9 items-center justify-center rounded-icon bg-zinc-100 text-zinc-700 dark:bg-zinc-800 dark:text-zinc-300">
            <BarChart3 size={18} />
          </div>
        ...
        <div className="flex justify-center">
          <a
            ...
            className="inline-flex min-h-14 w-full max-w-xl items-center rounded-surface justify-center gap-3 border border-zinc-900 bg-zinc-900 px-6 py-4 text-base font-bold text-white transition-colors hover:bg-zinc-800 focus:outline-none focus:ring-2 focus:ring-zinc-500 focus:ring-offset-2 focus:ring-offset-white dark:border-zinc-100 dark:bg-zinc-100 dark:text-zinc-900 dark:hover:bg-zinc-200 dark:ring-offset-zinc-950 sm:text-lg"
            title="查看 Umami 统计数据"
          >
            <BarChart3 size={20} />
