    ...
    <div className="pb-8 md:pb-14">
      ...
      <section className="mt-7 md:mt-9">
        {removeError && !loading && (
          <div
            role="alert"
            className="mb-4 flex items-center justify-between gap-3 border border-red-200 bg-red-50 px-4 py-3 text-sm text-red-700 dark:border-red-900/60 dark:bg-red-950/30 dark:text-red-300"
          >
            ...
            {posts.map((post) => (
              ...
              >
                ...
                <div className="flex flex-grow flex-col p-3.5 md:p-5">
                  ...
                  <p className="mb-2 line-clamp-1 text-sm leading-5 md:mb-3 text-zinc-600 dark:text-zinc-300">
                    {post.excerpt}
                  </p>
                  <div className="mt-auto flex items-center gap-3 border-t border-zinc-200 pt-2.5 text-[11px] md:pt-3 text-zinc-500 dark:border-zinc-800 dark:text-zinc-400">
                    <span className="flex items-center gap-1">
                      <Calendar size={11} />
                      {formatDate(post.date, 'zh-CN', { year: 'numeric', month: 'short', day: 'numeric' })}
                    </span>
                    <span className="flex items-center gap-1">
                      <Clock size={11} />
                      {post.readTime}
