...
export const Friends = () => {
  ...
  const [applicationResult, setApplicationResult] = useState<ReturnType<typeof createFriendLinkApplication> | null>(
    null,
  );
  ...
  const friendsPageDescription =
    'D-blog 友情链接汇集优秀技术博客与趣味网站，欢迎通过 GitHub PR 申请交换友链，一起分享交流与成长。';
    ...
    <div className="pb-12 pt-8 md:pb-20 md:pt-12">
        ...
        >
          <div className="min-w-0 flex-1">
            ...
            <p className="mt-1 text-sm leading-relaxed text-zinc-700 dark:text-zinc-300">
              添加本站友链 → 登录 GitHub → 填写信息并提交 Issue
            </p>
          </div>
          <motion.div
              ...
              <div className="border-t border-zinc-200 pb-5 pt-5 dark:border-zinc-800 sm:pb-6 sm:pt-6">
                <div className="space-y-6">
                  <Surface variant="panel" className="p-4 sm:p-5" aria-labelledby="friend-link-application-guide">
                    <div>
                      <h2
                        id="friend-link-application-guide"
                        className="text-base font-bold text-zinc-950 dark:text-zinc-100"
                      >
                        申请说明
                      </h2>
                      <p className="mt-1 text-sm leading-relaxed text-zinc-600 dark:text-zinc-400">
                        请按以下步骤完成申请，GitHub Issue 会记录申请并由 Action 自动检查反链。
                      </p>
                    </div>
                        ...
                        return (
                          <li key={title} className="relative flex gap-3">
                            {step < 4 && (
                              <span
                                aria-hidden="true"
                                className="absolute left-3 top-7 h-7 border-l border-zinc-300 dark:border-zinc-700"
                              />
                            )}
                            <span
                              className={`relative z-10 flex h-6 w-6 flex-shrink-0 items-center justify-center rounded-full text-xs font-bold ${completed || active ? 'bg-zinc-900 text-white dark:bg-zinc-100 dark:text-zinc-950' : 'bg-zinc-100 text-zinc-500 dark:bg-zinc-800 dark:text-zinc-400'}`}
                            >
                              {completed ? <Check size={14} /> : step}
                            </span>
                            <div className="min-w-0 flex-1">
                              <div
                                className={`font-semibold ${active ? 'text-zinc-950 dark:text-white' : 'text-zinc-600 dark:text-zinc-400'}`}
                  ...
                  <AnimatePresence mode="wait" initial={false}>
                          ...
                          <div className="flex flex-wrap items-start justify-between gap-3">
                            <div>
                              ...
                              <p className="mt-2 text-sm leading-relaxed text-zinc-600 dark:text-zinc-400">
                                请在 GitHub 官方页面完成登录。本站不会读取或保存你的 GitHub 账号信息。
                              </p>
                            </div>
                            <div className="flex flex-wrap gap-2">
                              <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="editorial-button inline-flex items-center gap-2"
                              >
                                <Github size={16} />
                                登录 GitHub
                              </a>
                              <button
                                type="button"
                                onClick={() => advanceApplicationStep(3)}
                                className="editorial-button-primary"
                              >
                                我已登录
                                <ArrowRight size={16} />
                    ...
                    {currentApplicationStep === 3 && (
                      ...
                      >
                        <form
                          noValidate
                          onSubmit={handleCompleteApplication}
                        ...
                        >
                          <div className="mb-4">
                            ...
                            <p className="mt-1 text-sm leading-relaxed text-zinc-600 dark:text-zinc-400">
                              填写完成后会生成预填好的 GitHub Issue。请确认友链页已公开可访问，Action 会在提交后约 10 至
                              15 分钟检查反链。
                            </p>
                          </div>
                          <div className="grid gap-4 sm:grid-cols-2">
                            ...
                            <label className="sm:col-span-2 flex min-h-11 cursor-pointer items-center gap-3 border-t border-zinc-200 py-2 text-sm leading-relaxed dark:border-zinc-800">
                              <input
                                ...
                                aria-describedby={
                                  applicationErrors.reciprocalLinkConfirmed ? 'reciprocal-link-error' : undefined
                                }
                              />
                              <span className="text-zinc-700 dark:text-zinc-300">
                                我已经先在自己的博客友链页加入 D-blog，并确认这个友链页可以直接访问。
                              </span>
                            </label>
                            {applicationErrors.reciprocalLinkConfirmed && (
                              <span
                                id="reciprocal-link-error"
                                className="sm:col-span-2 -mt-2 text-xs text-red-600 dark:text-red-400"
                              >
                                {applicationErrors.reciprocalLinkConfirmed}
                              </span>
                            )}
                          ...
                          <div className="mt-5 flex flex-col gap-2 border-t border-zinc-200 pt-4 sm:flex-row sm:flex-wrap sm:items-center sm:justify-between sm:border-0 sm:pt-0 dark:border-zinc-800">
                            <a
                              ...
                              target="_blank"
                              rel="noopener noreferrer"
                              className="editorial-button inline-flex items-center gap-2 px-4"
                            >
                              <Github size={16} />
                              登录 GitHub
                            </a>
                            <button
                              type="submit"
                              className="editorial-button-primary inline-flex w-full items-center gap-2 px-5 sm:w-auto"
                            >
                              <Github size={16} />
                              生成 GitHub Issue 草稿
                            </button>
                          ...
                          {applicationResult && (
                            <div className="mt-4 flex flex-wrap items-center justify-end gap-3 border-t border-zinc-200 pt-4 dark:border-zinc-800">
                              ...
                              <button
                                type="button"
                                onClick={() => advanceApplicationStep(4)}
                      ...
                      >
                        <Surface variant="panel" className="p-4 sm:p-5">
                          <div className="flex items-start gap-3">
                            <span className="flex h-7 w-7 flex-shrink-0 items-center justify-center rounded-full bg-zinc-900 text-white dark:bg-zinc-100 dark:text-zinc-950">
                              <Check size={16} />
                            </span>
                            <div>
                              ...
                              <p className="mt-2 text-sm leading-relaxed text-zinc-600 dark:text-zinc-400">
                                Issue 提交后，Action 会先评论确认，并在提交满 10 分钟后检查友链页。通常会在约 10 至 15
                                分钟内完成审核，检测通过后自动添加友链。
                              </p>
                            </div>
                          </div>
      ...
      >
        {!loading &&
          ...
          activeFriends.map((friend, index) => <FriendCard key={`${friend.url}-${index}`} friend={friend} />)}
          ...
          <div>
            <div className="flex items-start justify-between gap-4 border-b border-zinc-200 px-5 py-4 dark:border-zinc-800">
              <div>
                ...
                <p
                  id="friend-link-result-description"
            ...
            <div className="space-y-4 overflow-y-auto px-5 py-5">
              <div className="border border-zinc-200 bg-zinc-50 p-3 text-sm leading-relaxed text-zinc-700 dark:border-zinc-800 dark:bg-zinc-950 dark:text-zinc-300">
                ...
                <div className="mt-1">
                  GitHub Issue 标题会以 <code>[Friend Link]</code> 开头。提交后 bot 会先评论确认，并在约 10 至 15
                  分钟后检查你填写的友链页。
                </div>
              </div>
              <p className="text-xs leading-relaxed text-zinc-600 dark:text-zinc-400">
                检测通过后，D-blog 会自动添加友链；如果页面无法访问或找不到 D-blog 链接，Issue 会说明原因并关闭。GitHub
                的评论通知可能通过站内通知或邮件送达。
              </p>
              <div className="flex flex-wrap justify-end gap-2 border-t border-zinc-200 pt-4 dark:border-zinc-800">
                ...
                <a
                  href={applicationResult.issueUrl}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="editorial-button-primary inline-flex items-center gap-2 px-4"
                >
                  <Github size={15} />
                  前往 GitHub 提交 Issue
                </a>
