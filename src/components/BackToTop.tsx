    ...
    <>
      ...
      <button
        ...
        style={
          {
            '--back-to-top-bottom':
              'calc(var(--tab-bar-height, 0px) + var(--feedback-dock-height, 0px) + max(1.25rem, var(--cookie-notice-height, 0px) + var(--service-worker-prompt-height, 0px) + env(safe-area-inset-bottom, 0px) + 1.25rem))',
