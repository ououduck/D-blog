...
export const IssueSubscriptionCard = ({ compact = false }: { compact?: boolean }) => (
  <aside
    className={`border border-zinc-300 bg-zinc-50/70 p-4 dark:border-zinc-700 dark:bg-zinc-900/70 ${compact ? 'flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between' : 'rounded-surface sm:p-5'}`}
